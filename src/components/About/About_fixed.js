          ...
          <div className="about-grid">
            <motion.div variants={itemVariants} className="about-text">
              ...
              <motion.p variants={itemVariants} className="about-description">
                I'm MD EJAZUDDIN JAMADAR, a passionate Frontend Developer, UI/UX Designer, and MERN Stack Developer specializing in creating seamless digital experiences and building responsive web applications.
              </motion.p>
              
              <motion.p variants={itemVariants} className="about-description">
                With a Bachelor's degree in Information Science & Engineering and extensive hands-on experience, I have successfully delivered 25+ projects ranging from modern user interfaces to full-stack web applications. My expertise spans across frontend technologies, user experience design, and the complete MERN stack - from crafting intuitive user interfaces to developing robust backend solutions.
              </motion.p>
