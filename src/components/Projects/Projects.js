      ...
      <div className="container">
        ...
        >
          ...
          <motion.p variants={itemVariants} className="projects-description">
            Showcasing professional projects in frontend development, UI/UX design, and MERN stack development that demonstrate expertise in creating beautiful, user-centered digital experiences
          </motion.p>
